...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://blinding-fire-4831.firebaseIO.com/projects"));
  $scope.user = $firebase(new Firebase("https://blinding-fire-4831.firebaseIO.com/Users/truthreveller"));
